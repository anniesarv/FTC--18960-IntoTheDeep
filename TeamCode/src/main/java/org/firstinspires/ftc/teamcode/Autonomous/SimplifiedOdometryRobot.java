...
import org.firstinspires.ftc.teamcode.Autonomous.ProportionalControl;
...
public class SimplifiedOdometryRobot {
    ...
    private static final double DRIVE_ACCEL         = 100;     // Acceleration limit.  Percent Power change per second.  1.0 = 0-100% power in 1 sec.
    ...
    private static final double STRAFE_GAIN         = 0.1;      // Strength of lateral position control
    private static final double STRAFE_ACCEL        = 100;     // Acceleration limit.  Percent Power change per second.  1.0 = 0-100% power in 1 sec.
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("Left Front", DcMotor.Direction.REVERSE);
        rightFrontDrive = setupDriveMotor("Right Front", DcMotor.Direction.REVERSE);
